...
gst_audioanalysis_class_init (GstAudioAnalysisClass * klass)
{
  ...
  gst_element_class_set_static_metadata (GST_ELEMENT_CLASS (klass),
      ...
      "Audio data analysis",
      "filter for audio analysis", "freyr <sky_rider_93@mail.ru>");
  ...
  signals[STREAM_FOUND_SIGNAL] =
      ...
      G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET (GstAudioAnalysisClass,
  ...
  properties[PROP_SILENCE_CONT] =
      ...
      "Silence cont err meas", -70.0, -5.0, -35.0, G_PARAM_READWRITE);
  ...
  properties[PROP_SILENCE_PEAK] =
      ...
      "Silence peak err meas", -70.0, -5.0, -45.0, G_PARAM_READWRITE);
  ...
  properties[PROP_SILENCE_DURATION] =
      ...
      "Silence err duration", 0., G_MAXFLOAT, 10., G_PARAM_READWRITE);
  properties[PROP_LOUDNESS_CONT] =
      g_param_spec_float ("loudness_cont", "Loudness cont err boundary",
      "Loudness cont err meas", -70.0, -5.0, -21.9, G_PARAM_READWRITE);
  ...
  properties[PROP_LOUDNESS_PEAK] =
      ...
      "Loudness peak err meas", -70.0, -5.0, -15.0, G_PARAM_READWRITE);
  ...
  properties[PROP_LOUDNESS_DURATION] =
      ...
      "Loudness err duration", 0., G_MAXFLOAT, 2.0, G_PARAM_READWRITE);
    ...
    guint property_id, const GValue * value, GParamSpec * pspec)
{
  ...
  switch (property_id) {
    ...
    case PROP_SILENCE_CONT:
      audioanalysis->params_boundary[SILENCE_SHORTT].cont =
          g_value_get_float (value);
      audioanalysis->params_boundary[SILENCE_MOMENT].cont =
          g_value_get_float (value);
      break;
    case PROP_SILENCE_CONT_EN:
      audioanalysis->params_boundary[SILENCE_SHORTT].cont_en =
          g_value_get_boolean (value);
      audioanalysis->params_boundary[SILENCE_MOMENT].cont_en =
          g_value_get_boolean (value);
      break;
    case PROP_SILENCE_PEAK:
      audioanalysis->params_boundary[SILENCE_SHORTT].peak =
          g_value_get_float (value);
      audioanalysis->params_boundary[SILENCE_MOMENT].peak =
          g_value_get_float (value);
      break;
    case PROP_SILENCE_PEAK_EN:
      audioanalysis->params_boundary[SILENCE_SHORTT].peak_en =
          g_value_get_boolean (value);
      audioanalysis->params_boundary[SILENCE_MOMENT].peak_en =
          g_value_get_boolean (value);
      break;
    case PROP_SILENCE_DURATION:
      audioanalysis->params_boundary[SILENCE_SHORTT].duration =
          g_value_get_float (value);
      audioanalysis->params_boundary[SILENCE_MOMENT].duration =
          g_value_get_float (value);
      break;
    case PROP_LOUDNESS_CONT:
      audioanalysis->params_boundary[LOUDNESS_SHORTT].cont =
          g_value_get_float (value);
      audioanalysis->params_boundary[LOUDNESS_MOMENT].cont =
          g_value_get_float (value);
      break;
    case PROP_LOUDNESS_CONT_EN:
      audioanalysis->params_boundary[LOUDNESS_SHORTT].cont_en =
          g_value_get_boolean (value);
      audioanalysis->params_boundary[LOUDNESS_MOMENT].cont_en =
          g_value_get_boolean (value);
      break;
    case PROP_LOUDNESS_PEAK:
      audioanalysis->params_boundary[LOUDNESS_SHORTT].peak =
          g_value_get_float (value);
      audioanalysis->params_boundary[LOUDNESS_MOMENT].peak =
          g_value_get_float (value);
      break;
    case PROP_LOUDNESS_PEAK_EN:
      audioanalysis->params_boundary[LOUDNESS_SHORTT].peak_en =
          g_value_get_boolean (value);
      audioanalysis->params_boundary[LOUDNESS_MOMENT].peak_en =
          g_value_get_boolean (value);
      break;
    case PROP_LOUDNESS_DURATION:
      audioanalysis->params_boundary[LOUDNESS_SHORTT].duration =
          g_value_get_float (value);
      audioanalysis->params_boundary[LOUDNESS_MOMENT].duration =
          g_value_get_float (value);
      break;
    default:
...
gst_audioanalysis_setup (GstAudioFilter * filter, const GstAudioInfo * info)
{
  ...
  audioanalysis->lufs_state = ebur128_init (info->channels,
      (unsigned long) info->rate, EBUR128_MODE_S | EBUR128_MODE_M);
  /*
...
gst_audioanalysis_transform_ip (GstBaseTransform * trans, GstBuffer * buf)
{
  ...
  if (G_UNLIKELY (audioanalysis->next_evaluation_ts == 0
          || audioanalysis->next_data_message_ts == 0)) {
    audioanalysis->next_evaluation_ts = GST_BUFFER_TIMESTAMP (buf) + (GST_MSECOND * 90);        /* TODO: There should be 100ms
  ...
  num_frames = map.size / (GST_AUDIO_FILTER_BPS (audioanalysis)
      * GST_AUDIO_FILTER_CHANNELS (audioanalysis));

  ebur128_add_frames_short (audioanalysis->lufs_state, (short *) map.data,
      num_frames);
